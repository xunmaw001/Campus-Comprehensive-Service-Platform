        ...
        <form class="app-update-pv">
                 <view
                     ...
                     <input   disabled
                              ...
                              :disabled="ro.goodsUuidNumber" v-model="goods.goodsUuidNumber" placeholder="商品编号"></input>
                 </view>
                 <view
                         :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                         class="cu-form-group">
            ...
            <view
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#FE8010","borderRadius":"0px","color":"#FE8010","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.goodsOrderCourierName" type="text" v-model="ruleForm.goodsOrderCourierName" placeholder="快递公司"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#FE8010","borderRadius":"0px","color":"#FE8010","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.goodsOrderCourierNumber" type="text" v-model="ruleForm.goodsOrderCourierNumber" placeholder="快递单号"></input>
            </view>
...
<!-- text后缀 -->
            <view
                ...
                <textarea :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#FE8010","borderRadius":"0px","color":"#FE8010","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.goodsOrderText" v-model="ruleForm.goodsOrderText" placeholder="订单备注"/>
            </view>
    ...
    export default {
        ...
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.goodsOrderCourierName)) {
                    this.$utils.msg(`快递公司不能为空`);
                    return
                }
				if ((!this.ruleForm.goodsOrderCourierNumber)) {
                    this.$utils.msg(`快递单号不能为空`);
                    return
                }
				if ((!this.ruleForm.goodsOrderText)) {
