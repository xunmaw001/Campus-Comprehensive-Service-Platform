        ...
        <form class="app-update-pv">
			<view
                ...
                <textarea
                        ...
                        v-model='ruleForm.xiaoyuanshiwuzhaolingLiuyanText' placeholder="评论内容"></textarea>
            </view>
    ...
    export default {
        ...
        async onLoad(options) {
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`xiaoyuanshiwuzhaolingLiuyan`, this.ruleForm.id);
        ...
        methods: {
			...
			if ((!this.ruleForm.xiaoyuanshiwuzhaolingLiuyanText)) {
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`xiaoyuanshiwuzhaolingLiuyan`, this.ruleForm);
                } else {
                    await this.$api.save(`xiaoyuanshiwuzhaolingLiuyan`, this.ruleForm);
                }
