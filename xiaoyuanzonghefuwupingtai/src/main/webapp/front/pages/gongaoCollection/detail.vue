   	 ...
   	 <view style="margin-top: 10rpx;"></view>
					...
					<view class="detail-list-item"
						...
						<view class="text" :style='{"color":"#47EDB5","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.gongaoCollectionValue}}</view>
					</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('gongaoCollection', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.gongaoCollectionPhoto ? this.detail.gongaoCollectionPhoto.split(",") : [];
			},
