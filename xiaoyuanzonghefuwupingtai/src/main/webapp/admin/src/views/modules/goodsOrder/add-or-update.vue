        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="订单备注" prop="goodsOrderText">
                        <el-input type="textarea"  :readonly="ro.goodsOrderText" v-model="ruleForm.goodsOrderText" placeholder="订单备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.goodsOrderText" label="订单备注" prop="goodsOrderText">
                            <span v-html="ruleForm.goodsOrderText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
