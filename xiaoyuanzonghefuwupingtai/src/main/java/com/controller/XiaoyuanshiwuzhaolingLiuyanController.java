...
//                            xiaoyuanshiwuzhaolingLiuyanEntity.setXiaoyuanshiwuzhaolingLiuyanText(data.get(0));                    //评论内容 要改的
...
//                            xiaoyuanshiwuzhaolingLiuyanEntity.setUpdateTime(sdf.parse(data.get(0)));          //回复时间 要改的
